...
INSERT INTO topic (name, number, assessment_id, weight) VALUES
    ('Project objectives/Expected outcomes', 1, (SELECT id FROM assessment WHERE name = 'PROPOSAL_PRESENTATION'), 10),
    ('Cite recent developments pertaining to an engineering field', 2, (SELECT id FROM assessment WHERE name = 'PROPOSAL_PRESENTATION'), 20),
    ('Develop functional requirements by analyzing desired needs', 3, (SELECT id FROM assessment WHERE name = 'PROPOSAL_PRESENTATION'), 20),
    ('Develop technical and non-technical constraints', 4, (SELECT id FROM assessment WHERE name = 'PROPOSAL_PRESENTATION'), 10),
    ('Solution specifications', 5, (SELECT id FROM assessment WHERE name = 'PROPOSAL_PRESENTATION'), 15),
    ('Future work plan', 6, (SELECT id FROM assessment WHERE name = 'PROPOSAL_PRESENTATION'), 10),
    ('Oral expression', 7, (SELECT id FROM assessment WHERE name = 'PROPOSAL_PRESENTATION'), 10),
    ('Slides quality', 8, (SELECT id FROM assessment WHERE name = 'PROPOSAL_PRESENTATION'), 5),

    ('Meeting management', 1, (SELECT id FROM assessment WHERE name = 'PROGRESS_REPORT'), 20),
    ('Proposal report', 2, (SELECT id FROM assessment WHERE name = 'PROGRESS_REPORT'), 20),
    ('Progress report', 3, (SELECT id FROM assessment WHERE name = 'PROGRESS_REPORT'), 20),
    ('Proposed solution and implementation progress', 4, (SELECT id FROM assessment WHERE name = 'PROGRESS_REPORT'), 20),
    ('Motivation/initiative/creativity', 5, (SELECT id FROM assessment WHERE name = 'PROGRESS_REPORT'), 20),

    ('Acquire and apply new knowledge as needed, using appropriate learning strategies (7.1)',
        1, (SELECT id FROM assessment WHERE name = 'ADVISOR_ASSESSMENT'), 20),
    ('Function effectively on a team whose members together provide leadership, create a collaborative and inclusive environment, establish goals, plan tasks, and meet objectives (5.1)',
        2, (SELECT id FROM assessment WHERE name = 'ADVISOR_ASSESSMENT'), 20),
    ('Skills for engineering practice',
        3, (SELECT id FROM assessment WHERE name = 'ADVISOR_ASSESSMENT'), 20),
    ('Objectives/Achievement',
        4, (SELECT id FROM assessment WHERE name = 'ADVISOR_ASSESSMENT'), 20),
    ('Motivation/initiative/creativity/Meeting management',
        5, (SELECT id FROM assessment WHERE name = 'ADVISOR_ASSESSMENT'), 20),

    ('Project objectives/Outcomes',
        1, (SELECT id FROM assessment WHERE name = 'FINAL_REPORT'), 10),
    ('Background research/Related works',
        2, (SELECT id FROM assessment WHERE name = 'FINAL_REPORT'), 10),
    ('Develop functional requirements by analyzing desired needs (2.1)',
        3, (SELECT id FROM assessment WHERE name = 'FINAL_REPORT'), 10),
    ('Develop technical and non-technical constraints (2.2)',
        4, (SELECT id FROM assessment WHERE name = 'FINAL_REPORT'), 10),
    ('Problem formulation',
        5, (SELECT id FROM assessment WHERE name = 'FINAL_REPORT'), 10),
    ('Incorporate appropriate engineering standards and specifications related to the engineering design (2.3)',
        6, (SELECT id FROM assessment WHERE name = 'FINAL_REPORT'), 10),
    ('Propose multiple solutions and evaluate them against functional requirements and constraints (2.4)',
        7, (SELECT id FROM assessment WHERE name = 'FINAL_REPORT'), 10),
    ('Implement, test and iteratively improve a solution satisfying the specified functional requirements and constraints, considering risks, and making trade-offs (2.5)',
        8, (SELECT id FROM assessment WHERE name = 'FINAL_REPORT'), 5),
    ('Results presentation and analysis',
        9, (SELECT id FROM assessment WHERE name = 'FINAL_REPORT'), 5),
    ('Conclusion and perspectives',
        10, (SELECT id FROM assessment WHERE name = 'FINAL_REPORT'), 5),
    ('Make informed judgments by considering the impact of engineering solutions in global, economic, environmental and societal contexts (4.2)',
        11, (SELECT id FROM assessment WHERE name = 'FINAL_REPORT'), 5),
    ('Demonstrate written communication skills with a range of audience by writing adequate documents using appropriate format and language (3.1)',
        12, (SELECT id FROM assessment WHERE name = 'FINAL_REPORT'), 5),
    ('Scientific referencing',
        13, (SELECT id FROM assessment WHERE name = 'FINAL_REPORT'), 5),

    ('Project objectives/Outcomes',
        1, (SELECT id FROM assessment WHERE name = 'FINAL_PRESENTATION'), 10),
    ('Background research/Related works',
        2, (SELECT id FROM assessment WHERE name = 'FINAL_PRESENTATION'), 10),
    ('Develop functional requirements by analyzing desired needs (2.1)',
        3, (SELECT id FROM assessment WHERE name = 'FINAL_PRESENTATION'), 10),
    ('Develop technical and non-technical constraints (2.2)',
        4, (SELECT id FROM assessment WHERE name = 'FINAL_PRESENTATION'), 10),
    ('Propose multiple solutions and evaluate them against functional requirements and constraints (2.4)',
        5, (SELECT id FROM assessment WHERE name = 'FINAL_PRESENTATION'), 10),
    ('Implement, test and iteratively improve a solution satisfying the specified functional requirements and constraints, considering risks, and making trade-offs (2.5)',
        6, (SELECT id FROM assessment WHERE name = 'FINAL_PRESENTATION'), 10),
    ('Results and analysis',
        7, (SELECT id FROM assessment WHERE name = 'FINAL_PRESENTATION'), 10),
    ('Conclusion and perspectives',
        8, (SELECT id FROM assessment WHERE name = 'FINAL_PRESENTATION'), 10),
    ('Demonstrate oral communication skills with a range of audience by using appropriate verbal and non-verbal language, adopting the appropriate formatting and supporting material (3.2)',
        9, (SELECT id FROM assessment WHERE name = 'FINAL_PRESENTATION'), 10),
    ('Slides quality',
        10, (SELECT id FROM assessment WHERE name = 'FINAL_PRESENTATION'), 10);
